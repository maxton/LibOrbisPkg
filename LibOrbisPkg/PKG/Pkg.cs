...
namespace LibOrbisPkg.PKG
{
  ...
  public class Pkg
  {
    ...
    /* XXX: it's a custom structure to store stuff at runtime */
    //   struct file_map* map;
    //struct pfs* pfs;
    ...
    //ulong pfs_image_offset;
    //   ulong pfs_image_size;
    //   uint pfs_signed_size;
    //   ulong pfs_offset;
    //   ulong inner_pfs_offset;
    //   size_t entry_count;
    //   size_t sc_entry_count;
    //   pfs_ino image_file_ino;
  }

  public struct EntryDesc
  {
    Pkg.PkgTableEntry Entry;
